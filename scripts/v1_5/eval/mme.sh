...
python convert_answer_to_mme.py --experiment llava-vicuna-7b-v1.5-finetune_dual_20_data_merged

cd eval_tool

python calculation.py --results_dir answers/llava-vicuna-7b-v1.5-finetune_dual_20_data_merged
